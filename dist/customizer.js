...
(function() {
  var CanvasView, ChnageProductView, Customizer, CustomizerCollection, CustomizerModel, CustomizerProductCollection, CustomizerProductModel, CustomizerView, EditLayerView, ModelView, ViewLayerView, clipByName, degToRad, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
  ...
  ChnageProductView = (function(_super) {
    __extends(ChnageProductView, _super);

    function ChnageProductView() {
      _ref5 = ChnageProductView.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  ViewLayerView = (function(_super) {
    ...
    function ViewLayerView() {
      _ref6 = ViewLayerView.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  EditLayerView = (function(_super) {
    ...
    function EditLayerView() {
      _ref7 = EditLayerView.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
    ...
    EditLayerView.prototype.initialize = function(options) {
      ...
      return _ref8 = options.layer, this.canvas = _ref8.canvas, _ref8;
    };
  ...
  CustomizerView = (function(_super) {
    ...
    function CustomizerView() {
      _ref8 = CustomizerView.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
    ...
    CustomizerView.prototype.render = function() {
      var canvas, defaultCanvasArgs, el, subview, _i, _len, _ref9;
    ...
    CustomizerView.prototype.doAjaxSave = function(payload) {
      ...
      return jQuery.ajax({
        ...
        success: function(data) {
          var datum, _i, _len, _ref9;
          _this.updatingBatch = true;
          for (_i = 0, _len = data.length; _i < _len; _i++) {
            datum = data[_i];
            if ((_ref9 = _this.collection.get(datum.cid)) != null) {
              _ref9.set({
                id: datum.id
              });
            }
